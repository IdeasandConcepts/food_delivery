...
class OrderTracking extends StatefulWidget {
  ...
  const OrderTracking(
      {super.key, required this.order, required this.acceptingTime});
      ...
      child: SingleChildScrollView(
        child: Column(
          ...
          children: [
            ...
            //           child: TextButton(
            //               onPressed: (){},
            //               child: Text("OrderTrackinging" , style:    TextStyle(fontSize: 14,fontWeight: FontWeight.w500, color: Colors.white)),)),
            //
            //
            //
            //
              ...
              child: Column(
                ...
                children: [
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      "assets/images/line.jpeg",
                      height: 60.h,
                      color: (widget.order.step == "In Kitchen")
                          ? kprimaryColor
                          : Colors.black,
                    ),
                  ),
                  ...
                  Padding(
                    ...
                    child: Image.asset(
                      "assets/images/line.jpeg",
                      height: 60.h,
                      color: (widget.order.step == "Accept")
                          ? kprimaryColor
                          : Colors.black,
                    ),
                  ),
                  ...
                  _proccesOrder(
                      ...
                      (isConfirmed == true) ? kprimaryColor : Colors.grey),
                ],
              ),
            ),
