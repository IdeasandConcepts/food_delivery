...
class OrderDetails extends StatelessWidget {
            ...
            children: [
              ...
              Padding(
                  ...
                  child: Row(
                    ...
                    children: [
                      Text(
                        "${userOrdersList.requests.length}" + "\t" + "items",
                        style: TTextTheme.lightTextThem.bodyLarge,
                      ),
                      Text(
              ...
              Row(
                ...
                children: [
                  ...
                  Padding(
                    padding: const EdgeInsets.all(8.0),
                    child:
                        Text("\$ ", style: TTextTheme.lightTextThem.bodyMedium),
                  )
                ],
              ),
              SizedBox(
  ...
  getSelectedButton(
      ...
      required String elevatedTitle,
      void Function()? onPressedElevated,
      void Function()? onPressedOutline}) {
    return Container(
      color: Colors.white,
      width: width,
      height: 100,
