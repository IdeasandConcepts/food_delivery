...
// ),
          Padding(
            padding:  EdgeInsets.only(top:MediaQuery.of(context).size.height * 1 / 220,),
            child: Container(
...
//margin: EdgeInsets.all(8),
                    ...
                    Padding(
                      padding:  EdgeInsets.only(top:MediaQuery.of(context).size.height * 1 / 170,),
                      child: Row(
// crossAxisAlignment: CrossAxisAlignment.start,
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          (widget.product.isFavorite!=true) ?Row(
...
//highlightColor: Colors.black,
                                  ...
                                  userFavoriteMeals.add(FavoriteMeals(
                                      products: widget.product, userName: widget.user
                                  ));
...
//                         }
                        ...
                        Get.to(()=>MyCartScreen(
                        //  phoneNumber: widget.phoneNumber,
                          user: widget.user, profileImage: widget.profileImage,
                        ));
                      },
                      child: Container(
