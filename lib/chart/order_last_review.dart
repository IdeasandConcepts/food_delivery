                  ...
                  child: Container(
                    ...
                    child: Row(
                      ...
                      children: <Widget>[
                        ...
                        Text("${widget.totalAmount}", style: TextStyle(
                            fontSize: 16,fontWeight: FontWeight.bold
                        ),)
                      ],
                    ),
                ...
                child: Container(
                  ...
                  child: Row(
                    ...
                    children: <Widget>[
                      ...
                      Text("${widget.userOrdersList.length}", style: TextStyle(
                          fontSize: 16,fontWeight: FontWeight.bold
                      ),)
                    ],
                  ),
                      ...
                      onPressed: () async{
                       ...
                       // Create order
                        ...
                        createTask(Orders(
                          ...
                          status: "New Order",
                          orderNumber: Random().nextInt(17565777).toDouble(),
